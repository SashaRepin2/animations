...
function Circle(id, positionX, positionY, radius, fill, stroke, strokeWidth) {
	...
	this.draw = function () {
		JScontentCreation.innerHTML += `<circle id="${id}" cx="${this.positionX}" cy="${this.positionY}" r="${this.radius}"
